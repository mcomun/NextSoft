...
Delfin.Web.Std.Components.Dialog = function (opts) {
   this.init(opts);
};

Delfin.Web.Std.Components.Dialog.prototype = {
   idDivDialog: 'divDialogDelfin',
   ...
   getAjaxContent: function (opts) {
      var me = this;
      var ajaxBuscar = new Delfin.Web.Std.Components.Ajax({
         action: opts.action,
         dataType: 'html',
         data: opts.data,
         onSuccess: function (html) {
            me.setContent(html);
            Delfin.Web.Std.Components.TextBox.Function.Configure(me.idDivDialog);
