...
{
   public partial class MAN008LView : UserControl, IMAN008LView
   {
      #region [ Variables ]
      ...
      #region [ Formulario ]
      public MAN008LView(Telerik.WinControls.UI.RadPageViewPage x_tabPageControl)
      {
         InitializeComponent();
         try
         {
      ...
      private void FormatDataGrid()
      {
         try
         {
            ...
            this.grdItems.Columns.Add("PACK_Codigo", "Codigo Paquete", "PACK_Codigo");
            this.grdItems.Columns.Add("PACK_Desc", "Descripción", "PACK_Desc");
            this.grdItems.Columns.Add("PACK_DescC", "Descripción Corta", "PACK_DescC");
            this.grdItems.Columns.Add("TIPO_Desc1_Pack", "Paquete", "TIPO_Desc1_Pack");
            this.grdItems.Columns.Add("TIPO_Desc1_Tam", "Tamaño", "TIPO_Desc1_Tam");
            this.grdItems.Columns.Add("TIPO_Desc1_Cont", "Contenedor", "TIPO_Desc1_Cont");
      ...
      private void SeleccionarItem()
      {
         try
         {
            if (Presenter != null)
            {
               if (BSItems != null && BSItems.Current != null && BSItems.Current is Entities.Paquete)
               { Presenter.Item = ((Entities.Paquete)BSItems.Current); }
               else
               { Presenter.Item = null; }
            }
         }
