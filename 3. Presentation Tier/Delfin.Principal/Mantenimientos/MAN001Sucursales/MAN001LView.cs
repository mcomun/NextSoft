...
{
   public partial class MAN001LView : UserControl, IMAN001LView
   {
      #region [ Variables ]
      ...
      #region [ Formulario ]
      public MAN001LView(Telerik.WinControls.UI.RadPageViewPage x_tabPageControl)
      {
         InitializeComponent();
         try
         {
            ...
            cmbMAN.SelectedIndexChanged += comboBox1_SelectedIndexChanged;
      ...
      public void LoadView()
      {
         try
         {
            ...
            cmbMAN.DataSource = Presenter.ItemsEmpresas;
            cmbMAN.ValueMember = "EMPR_Codigo";
            cmbMAN.DisplayMember = "EMPR_RazonSocial";
      ...
      private void FormatDataGrid()
      {
         try
         {
            ...
            this.grdItems.Columns.Add("SUCR_Codigo", "Código", "SUCR_Codigo");
            this.grdItems.Columns.Add("SUCR_Desc", "Descripción", "SUCR_Desc");
            this.grdItems.Columns.Add("SUCR_DescC", "Descripción Corta", "SUCR_DescC");
            this.grdItems.Columns.Add("SUCR_RUC", "RUC", "SUCR_RUC");
            this.grdItems.Columns.Add("SUCR_Direc", "Dirección", "SUCR_Direc");
      ...
      private void SeleccionarTabla()
      {
         try
         {
             if (cmbMAN.SelectedItem != null && cmbMAN.SelectedItem is Entities.Empresa)
             { Presenter.ItemEmpresa = (Entities.Empresa)cmbMAN.SelectedItem; }
             else
             { Presenter.ItemEmpresa = null; }

             btnMAN_Nuevo.Enabled = (Presenter.ItemEmpresa != null);
             btnMAN_Buscar.Enabled = (Presenter.ItemEmpresa != null);
         }
         catch (Exception ex)
      ...
      private void SeleccionarItem()
      {
         try
         {
            if (Presenter != null)
            {
               if (BSItems != null && BSItems.Current != null && BSItems.Current is Entities.Sucursales)
               { Presenter.Item = ((Entities.Sucursales)BSItems.Current); }
               else
               { Presenter.Item = null; }
            }
         }
      ...
      private void cmbSUCR_Empresas_SelectedIndexChanged(object sender, EventArgs e)
      {
