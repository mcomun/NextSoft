namespace Delfin.Principal
{
   partial class MAN005LView
   {
      ...
      private void InitializeComponent()
      {
         ...
         this.cmbENTC_NombreCompleto = new System.Windows.Forms.ComboBox();
         ...
         this.tableLayoutPanel1.Controls.Add(this.cmbENTC_NombreCompleto, 1, 0);
         ...
         // 
         // cmbENTC_NombreCompleto
         // 
         this.tableLayoutPanel1.SetColumnSpan(this.cmbENTC_NombreCompleto, 3);
         this.cmbENTC_NombreCompleto.DropDownStyle = System.Windows.Forms.ComboBoxStyle.DropDownList;
         this.cmbENTC_NombreCompleto.FormattingEnabled = true;
         this.cmbENTC_NombreCompleto.Location = new System.Drawing.Point(153, 3);
         this.cmbENTC_NombreCompleto.Name = "cmbENTC_NombreCompleto";
         this.cmbENTC_NombreCompleto.Size = new System.Drawing.Size(359, 21);
         this.cmbENTC_NombreCompleto.TabIndex = 79;
         // 
         // panelCaption1
         // 
         ...
         this.TitleView.Caption = "Mantenimiento de Contratos";
      ...
      private System.Windows.Forms.ComboBox cmbENTC_NombreCompleto;
