...
{
   public partial class MAN006LView : UserControl, IMAN006LView
   {
      #region [ Variables ]
      ...
      public void LoadView()
      {
         try
         {
            ...
            cmbMAN.LoadControl(Presenter.ContainerService, "Tabla Paises", "PAI", "< Seleccionar País >", ListSortDirection.Ascending);
      ...
      private void SeleccionarItem()
      {
         try
         {
            if (Presenter != null)
            {
               if (BSItems != null && BSItems.Current != null && BSItems.Current is Entities.Ubigeos)
               { Presenter.Item = ((Entities.Ubigeos)BSItems.Current); }
               else
               { Presenter.Item = null; }
            }
         }
      ...
      private void Buscar()
      {
         try
         {
            Presenter.ItemTabla = cmbMAN.TiposSelectedItem;
