...
{
   public partial class MAN000LView : UserControl, IMAN000LView
   {
      #region [ Variables ]
      ...
      #region [ Formulario ]
      public MAN000LView(Telerik.WinControls.UI.RadPageViewPage x_tabPageControl)
      {
         InitializeComponent();
         try
         {
      ...
      private void FormatDataGrid()
      {
         try
         {
            ...
            this.grdItems.Columns.Add("EMPR_Codigo", "Código", "EMPR_Codigo");
            this.grdItems.Columns.Add("EMPR_RUC", "R.U.C.", "EMPR_RUC");
            this.grdItems.Columns.Add("EMPR_RazonSocial", "Razón Social", "EMPR_RazonSocial");
            this.grdItems.Columns.Add("EMPR_RazonComercial", "Representante Legal", "EMPR_RazonComercial");
            this.grdItems.Columns.Add("EMPR_Direccion", "Dirección", "EMPR_Direccion");
      ...
      private void SeleccionarItem()
      {
         try
         {
            if (Presenter != null)
            {
               if (BSItems != null && BSItems.Current != null && BSItems.Current is Entities.Empresa)
               { Presenter.Item = ((Entities.Empresa)BSItems.Current); }
               else
               { Presenter.Item = null; }
            }
         }
