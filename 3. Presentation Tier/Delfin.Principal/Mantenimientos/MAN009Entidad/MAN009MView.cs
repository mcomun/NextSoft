   ...
   public partial class MAN009MView : Form, IMAN009MView
   {
        ...
        public MAN009MView()
      {
         ...
         try
         {
            ...
            btnExtranet.Click += new EventHandler(btnExtranet_Click);
      ...
      public void GetItem()
      {
         try
         {
            ...
            Presenter.Item.ENTC_Origen = "ERP";
      ...
      private void btnGuardar_Click(object sender, EventArgs e)
      {
        ...
        {
            DataRow drNuevoRegistro;
            ApplicationForm.CustomerRegisterRequestForm oRegisterForm = new ApplicationForm.CustomerRegisterRequestForm();
            oRegisterForm.ShowDialog();
            drNuevoRegistro = oRegisterForm.drEntidadRegistro;
            if (drNuevoRegistro != null)
            {
                cmbTIPO_CodTDI.SelectedValue =  drNuevoRegistro["TIPO_CodTDI"];
                txtENTC_DocIden.Text = drNuevoRegistro["ENTC_DocIden"].ToString();
                txtENTC_RazonSocial.Text = drNuevoRegistro["ENTC_RazonSocial"].ToString();
                txtENTC_NomComercial.Text = drNuevoRegistro["ENTC_RazonSocial"].ToString();
                txtENTC_EMail.Text = drNuevoRegistro["ENTC_EMail"].ToString();
                txtENTC_EMailFE.Text = drNuevoRegistro["ENTC_EMailReceptorFE"].ToString();
                txtENTC_Telef1.Text = drNuevoRegistro["ENTC_Telef1"].ToString();
                Presenter.Item.ENTC_Origen = drNuevoRegistro["ENTC_Origen"].ToString();
                Presenter.REGI_Codigo = int.Parse(drNuevoRegistro["REGI_Codigo"].ToString());
            }
        }
      ...
      private void chkENTC_OcultarShipper_CheckedChanged(object sender, EventArgs e)
      {
        ...
        private void btnExtranet_Click_1(object sender, EventArgs e)
        {
