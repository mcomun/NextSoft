...
{
    public partial class MAN010LView : UserControl, IMAN010LView
    {
        #region [ Variables ]
        ...
        #region [ Formulario ]
        public MAN010LView(Telerik.WinControls.UI.RadPageViewPage x_tabPageControl)
        {
            InitializeComponent();
            try
            {
        ...
        private void FormatDataGrid()
        {
            try
            {
                ...
                this.grdItems.Columns.Add("NAVE_Codigo", "Codigo", "NAVE_Codigo");
                this.grdItems.Columns.Add("NAVE_Nombre", "Nombre Nave", "NAVE_Nombre");
                this.grdItems.Columns.Add("VIA", "VIA", "VIA");
                this.grdItems.Columns.Add("ENTIDADEMISORA", "Entidad Emisora", "ENTIDADEMISORA");
                this.grdItems.Columns.Add("NAVE_Matricula", "Matricula", "NAVE_Matricula");
               // this.grdItems.Columns.Add("ENTC_NomCompleto", "Transportista", "ENTC_NomCompleto");
                //'NAVE_Codigo  , N.NAVE_Nombre  , N.ENTC_CodTransportista , E.ENTC_NomCompleto 
        ...
        private void SeleccionarItem()
        {
            try
            {
                if (Presenter != null)
                {
                    if (BSItems != null && BSItems.Current != null && BSItems.Current is Entities.Nave)
                    { Presenter.Item = ((Entities.Nave)BSItems.Current); }
                    else
                    { Presenter.Item = null; }
                }
            }
