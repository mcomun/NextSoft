...
{
   public partial class MAN014LView : UserControl, IMAN014LView
   {
      #region [ Variables ]
      ...
      #region [ Formulario ]
      public MAN014LView(Telerik.WinControls.UI.RadPageViewPage x_tabPageControl)
      {
         InitializeComponent();
         try
         {
      ...
      public void LoadView()
      {
         try
         {
            ...
            mdtFILTRO_FechaDesde.NSFecha = Presenter.Session.Fecha.AddMonths(-1);
            mdtFILTRO_FechaHasta.NSFecha = Presenter.Session.Fecha;
      ...
      private void FormatDataGrid()
      {
         try
         {
            ...
            this.grdItems.Columns.Add("COMI_Codigo", "Código", "COMI_Codigo");
            this.grdItems.Columns.Add("COMI_FecIni", "Fecha Inicio", "COMI_FecIni");
            this.grdItems.Columns.Add("COMI_FecFin", "Fecha Fin", "COMI_FecFin");
      ...
      private void SeleccionarItem()
      {
         try
         {
            if (Presenter != null)
            {
               if (BSItems != null && BSItems.Current != null && BSItems.Current is Entities.Comision)
               { Presenter.Item = ((Entities.Comision)BSItems.Current); }
               else
               { Presenter.Item = null; }
            }
         }
      ...
      private void Buscar()
      {
         try
         {
            ...
            Presenter.FILTRO_FechaDesde = mdtFILTRO_FechaDesde.NSFecha;
            Presenter.FILTRO_FechaHasta = mdtFILTRO_FechaHasta.NSFecha;
