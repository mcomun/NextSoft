...
{
   public partial class CAJ016FacturacionLView : UserControl, ICAJ016FacturacionLView
   {
      #region [ Variables ]
      ...
      #region [ Formulario ]
      public CAJ016FacturacionLView(Telerik.WinControls.UI.RadPageViewPage x_tabPageControl)
      {
         InitializeComponent();
         try
         {
      ...
      #region [ ICAJ016FacturacionLView ]
