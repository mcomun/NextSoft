              ...
              if (e.CellElement is GridCommandCellElement)
              {
                  if (e.Column.Name.Equals("Edit"))
                  {
                      ...
                      if (bte.Image == null)
                      {
                          ...
                          bte.Image = Delfin.Principal.Properties.Resources.editar16x16;
                  ...
                  if (e.Column.Name.Equals("Delete"))
                  {
                      ...
                      if (bte.Image == null)
                      {
                          ...
                          bte.DisplayStyle = DisplayStyle.Image;
                          bte.ImageAlignment = ContentAlignment.MiddleCenter;
                          bte.Image = Delfin.Principal.Properties.Resources.Sign_07;
                  ...
                  if (e.Column.Name.Equals("Anular"))
                  {
                      ...
                      if (bte.Image == null)
                      {
                          ...
                          bte.DisplayStyle = DisplayStyle.Image;
                          bte.ImageAlignment = ContentAlignment.MiddleCenter;
                          bte.Image = Delfin.Principal.Properties.Resources.Sign_09;
