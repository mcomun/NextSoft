...
{
   public partial class COM011LView : UserControl, ICOM011LView
   {
      #region [ Variables ]
      ...
      #region [ Formulario ]
      public COM011LView(Telerik.WinControls.UI.RadPageViewPage x_tabPageControl)
      {
         InitializeComponent();
         try
         {
      ...
      public COM011Presenter Presenter { get; set; }
