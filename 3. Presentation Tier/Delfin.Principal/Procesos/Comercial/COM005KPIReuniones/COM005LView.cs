...
{
   public partial class COM005LView : UserControl, ICOM005LView
   {
      #region [ Variables ]
      ...
      #region [ Formulario ]
      public COM005LView(Telerik.WinControls.UI.RadPageViewPage x_tabPageControl)
      {
         InitializeComponent();
         try
         {
      ...
      public COM005Presenter Presenter { get; set; }
