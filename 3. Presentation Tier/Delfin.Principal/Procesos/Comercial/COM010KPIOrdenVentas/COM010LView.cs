...
{
   public partial class COM010LView : UserControl, ICOM010LView
   {
      #region [ Variables ]
      ...
      #region [ Formulario ]
      public COM010LView(Telerik.WinControls.UI.RadPageViewPage x_tabPageControl)
      {
         InitializeComponent();
         try
         {
      ...
      public COM010Presenter Presenter { get; set; }
