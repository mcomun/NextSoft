...
{
   public partial class COM000Presenter
   {
      #region [ Variables ]
      public String Title = "Template";
      public String CUS = "COM000";
      public Boolean FleteNegativo = false;
      #endregion

      #region [ Contrusctor ]
      public COM000Presenter(IUnityContainer x_container, ICOM000LView x_lview, ICOM000MView x_mview, Int16 x_CCOT_Tipo)
      {
         try
         {
      ...
      public COM000Presenter(IUnityContainer x_container, ICOM000MView x_mview, Int16 x_CCOT_Tipo)
      {
         try
         {
            this.ContainerService = x_container;
      ...
      public ICOM000LView LView { get; set; }
      public ICOM000MView MView { get; set; }
      ...
      public void Nuevo()
      {
         try
         {
               ...
               isMViewShow = true;
               ((COM000MView)MView).Show();
               ((COM000MView)MView).BringToFront();
