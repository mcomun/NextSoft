...
{
   public partial class REP002LView : UserControl, IREP002LView
   {
      #region [ Variables ]
      ...
      #region [ Formulario ]
      public REP002LView(Telerik.WinControls.UI.RadPageViewPage x_tabPageControl)
      {
         InitializeComponent();
         try
         {
      ...
      public REP002Presenter Presenter { get; set; }
