...
{
    public partial class REP013LView : UserControl, IREP013LView
    {
        #region [ Variables ]
        ...
        #region [ Formulario ]
        public REP013LView(Telerik.WinControls.UI.RadPageViewPage x_tabPageControl)
        {
            InitializeComponent();
            try
            {
        ...
        public REP013Presenter Presenter { get; set; }
        ...
        private void Buscar()
        {
            ...
            {
                String _mensaje = "";
                if (!String.IsNullOrEmpty(txtCCOT_NumDoc.Text) || !String.IsNullOrEmpty(txtDOOV_HBL.Text) || mdtCCOT_FecIniCancelado.NSFecha != null || mdtCCOT_FecFinCancelado.NSFecha != null)
                {
                    ...
                    _fec_ini_concluye = mdtCCOT_FecIniCancelado.NSFecha;
                    _fec_fin_concluye = mdtCCOT_FecFinCancelado.NSFecha;
                    ...
                    Presenter.CargarReporte(_fec_ini_concluye, _fec_fin_concluye, _nro_hbl, _nro_ordenventa, _codigo_ejecutivo, _codigo_cliente);
                }
                else
                {
                    _mensaje += "* Fecha de Inicio de Cancelado" + Environment.NewLine;
                    _mensaje += "* Fecha de Fin de Cancelado" + Environment.NewLine; ;
        ...
        private void Deshacer()
        {
            try
            {
                ...
                mdtCCOT_FecIniCancelado.NSFecha = null;
                mdtCCOT_FecFinCancelado.NSFecha = null;
