...
{
   public class REP012Presenter
   {
      #region [ Variables ]
      public String Title = "Reporte de PROFIT - NEGATIVO";
      public String CUS = "REP012";
      #endregion

      #region [ Contrusctor ]
      public REP012Presenter(IUnityContainer x_container, IREP012LView x_lview)
      {
         try
         {
      ...
      public IREP012LView LView { get; set; }
      ...
      #region [ Metodos ]
      public void CargarReporte(Nullable<DateTime> FEC_IniConcluye, Nullable<DateTime> FEC_FinConcluye, String DOOV_HBL, String CCOT_NumDoc , Nullable<Int32> ENTC_Transportista, Nullable<Int32> ENTC_Ejecutivo, Nullable<Int32> ENTC_Cliente)
      {
         try
         {
            ...
            DTReporte = Client.GetAllCab_Cotizacion_OVByProfitNegativo(EMPR_Codigo, SUCR_Codigo, FEC_IniConcluye, FEC_FinConcluye, DOOV_HBL, CCOT_NumDoc, ENTC_Transportista, ENTC_Ejecutivo, ENTC_Cliente, ref _mensaje);
