...
{
   public class REP004Presenter
   {
      #region [ Variables ]
      public String Title = "Reporte de Tarifas Costo";
      public String CUS = "REP004";
      #endregion

      #region [ Contrusctor ]
      public REP004Presenter(IUnityContainer x_container, IREP004LView x_lview)
      {
         try
         {
      ...
      public IREP004LView LView { get; set; }
      ...
      public void CargarReporte(String CONS_TabRGM, String CONS_CodRGM, String CONS_TabVIA, String CONS_CodVIA, DateTime CONT_Fecha, Nullable<Int32> PACK_Codigo, Nullable<Int32> ENTC_CodTransportista, Nullable<Int32> CONT_Codigo, Nullable<Int32> PUER_CodOrigen, Nullable<Int32> PUER_CodDestino, Boolean CONT_Activo)
      {
         try
         {
            ...
            DTReporte = Client.GetAllContratoByReporteCosto(Delfin.Controls.Entorno.ItemEmpresa.EMPR_Codigo, CONS_TabRGM, CONS_CodRGM, CONS_TabVIA, CONS_CodVIA, CONT_Fecha, PACK_Codigo, ENTC_CodTransportista, CONT_Codigo, PUER_CodOrigen, PUER_CodDestino, CONT_Activo);
