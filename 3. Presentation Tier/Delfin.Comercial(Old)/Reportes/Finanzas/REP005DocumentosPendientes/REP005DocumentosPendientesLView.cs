...
{
   public partial class REP005DocumentosPendientesLView : UserControl, IREP005DocumentosPendientesLView
   {      
     #region [ Variables ]
      ...
      public REP005DocumentosPendientesLView(Telerik.WinControls.UI.RadPageViewPage x_tabPageControl)
      {
         InitializeComponent();
         try
         {
      ...
      public REP005DocumentosPendientesPresenter Presenter { get; set; }

      #endregion

      #region [ REP005DocumentosPendientesLView ]
