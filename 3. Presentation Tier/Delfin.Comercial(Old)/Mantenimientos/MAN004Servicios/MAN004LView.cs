...
{
    public partial class MAN004LView : UserControl, IMAN004LView
    {
        #region [ Variables ]
        ...
        #region [ Formulario ]
        public MAN004LView(Telerik.WinControls.UI.RadPageViewPage x_tabPageControl)
        {
            InitializeComponent();
            try
            {
        ...
        private void SeleccionarItem()
        {
            try
            {
                if (Presenter != null)
                {
                    ...
                    { Presenter.Item = ((Entities.Servicio)BSItems.Current); }
                    else
                    { Presenter.Item = null; }
                }
            }
        ...
        private void Deshacer()
        {
            try
            {
                ...
                CONS_CodRGM.SelectedIndex = 0;
                CONS_CodVia.SelectedIndex = 0;
                CONS_CodLNG.SelectedIndex = 0;
                SERV_TipoMov.SelectedIndex = 0;
