namespace Delfin.Comercial
{
    partial class MAN009LView
    {
        ...
        private void InitializeComponent()
        {
         ...
         System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(MAN009LView));
         ...
         this.EntidadAyuda = new Delfin.Controls.Entidad(this.components);
         this.lblEntidadM = new System.Windows.Forms.Label();
         this.TxtRazonSocialAyudaEntidad = new Infrastructure.WinForms.Controls.TextBoxAyuda(this.components);
         ...
         this.txtENTC_RazonSoc = new System.Windows.Forms.TextBox();
         ...
         this.navItems.Size = new System.Drawing.Size(730, 29);
         ...
         this.panelCaption2.Size = new System.Drawing.Size(730, 26);
         ...
         this.pnBotones.Size = new System.Drawing.Size(730, 50);
         ...
         this.TitleView.Caption = "Mantenimiento de Clientes";
         ...
         this.TitleView.Size = new System.Drawing.Size(730, 26);
         this.TitleView.TabIndex = 0;
         // 
         // grdItems
         // 
         this.grdItems.Dock = System.Windows.Forms.DockStyle.Fill;
         this.grdItems.Location = new System.Drawing.Point(0, 129);
         this.grdItems.Name = "grdItems";
         this.grdItems.Size = new System.Drawing.Size(730, 263);
         this.grdItems.TabIndex = 5;
         this.grdItems.TabStop = false;
         // 
         // EntidadAyuda
         // 
         this.EntidadAyuda.ActivarAyudaAuto = false;
         this.EntidadAyuda.ContainerService = null;
         this.EntidadAyuda.EnabledAyudaButton = true;
         this.EntidadAyuda.Location = new System.Drawing.Point(69, 3);
         this.EntidadAyuda.LongitudAceptada = 0;
         this.EntidadAyuda.MyInstanciaAyuda = Delfin.Controls.Entidad.InstanciaAyuda.Habilitado;
         this.EntidadAyuda.Name = "EntidadAyuda";
         this.EntidadAyuda.RellenaCeros = false;
         this.EntidadAyuda.Size = new System.Drawing.Size(447, 20);
         this.EntidadAyuda.TabIndex = 12;
         this.EntidadAyuda.Tipo = Delfin.Controls.Entidad.TipoTextBoxAyuda.AlfaNumerico;
         this.EntidadAyuda.Value = null;
         // 
         // lblEntidadM
         // 
         this.lblEntidadM.AutoSize = true;
         this.lblEntidadM.Location = new System.Drawing.Point(10, 7);
         this.lblEntidadM.Margin = new System.Windows.Forms.Padding(10, 7, 3, 0);
         this.lblEntidadM.Name = "lblEntidadM";
         this.lblEntidadM.Size = new System.Drawing.Size(42, 13);
         this.lblEntidadM.TabIndex = 11;
         this.lblEntidadM.Text = "Cliente:";
         // 
         // TxtRazonSocialAyudaEntidad
         // 
         this.TxtRazonSocialAyudaEntidad.ActivarAyudaAuto = false;
         this.TxtRazonSocialAyudaEntidad.EnabledAyuda = true;
         this.TxtRazonSocialAyudaEntidad.EnabledAyudaButton = true;
         this.TxtRazonSocialAyudaEntidad.EsFiltro = false;
         this.TxtRazonSocialAyudaEntidad.Location = new System.Drawing.Point(381, 3);
         this.TxtRazonSocialAyudaEntidad.LongitudAceptada = 0;
         this.TxtRazonSocialAyudaEntidad.MyInstanciaAyuda = Infrastructure.WinForms.Controls.TextBoxAyuda.InstanciaAyuda.Habilitado;
         this.TxtRazonSocialAyudaEntidad.Name = "TxtRazonSocialAyudaEntidad";
         this.TxtRazonSocialAyudaEntidad.RellenaCeros = false;
         this.TxtRazonSocialAyudaEntidad.Size = new System.Drawing.Size(324, 20);
         this.TxtRazonSocialAyudaEntidad.TabIndex = 13;
         this.TxtRazonSocialAyudaEntidad.Tipo = Infrastructure.WinForms.Controls.TextBoxAyuda.TipoTextBoxAyuda.AlfaNumerico;
         this.TxtRazonSocialAyudaEntidad.Value = null;
         // 
         // tableLayoutPanel1
         // 
         ...
         this.tableLayoutPanel1.Controls.Add(this.lblENTC_DocIden, 0, 0);
         this.tableLayoutPanel1.Controls.Add(this.txtENTC_DocIden, 1, 0);
         this.tableLayoutPanel1.Controls.Add(this.txtENTC_RazonSoc, 4, 0);
         this.tableLayoutPanel1.Dock = System.Windows.Forms.DockStyle.Top;
         this.tableLayoutPanel1.Location = new System.Drawing.Point(0, 102);
         this.tableLayoutPanel1.Name = "tableLayoutPanel1";
         this.tableLayoutPanel1.RowCount = 1;
         this.tableLayoutPanel1.RowStyles.Add(new System.Windows.Forms.RowStyle(System.Windows.Forms.SizeType.Absolute, 27F));
         this.tableLayoutPanel1.Size = new System.Drawing.Size(730, 27);
         ...
         this.lblENTC_DocIden.Location = new System.Drawing.Point(10, 7);
         ...
         this.lblENTC_DocIden.TabIndex = 0;
         this.lblENTC_DocIden.Text = "Número Documento:";
         // 
         // txtENTC_DocIden
         // 
         this.txtENTC_DocIden.Location = new System.Drawing.Point(153, 3);
         this.txtENTC_DocIden.Name = "txtENTC_DocIden";
         this.txtENTC_DocIden.Size = new System.Drawing.Size(194, 20);
         this.txtENTC_DocIden.TabIndex = 1;
         // 
         // txtENTC_RazonSoc
         // 
         this.txtENTC_RazonSoc.Location = new System.Drawing.Point(518, 3);
         this.txtENTC_RazonSoc.Name = "txtENTC_RazonSoc";
         this.txtENTC_RazonSoc.Size = new System.Drawing.Size(194, 20);
         this.txtENTC_RazonSoc.TabIndex = 3;
         // 
         // panelCaption1
         // 
         ...
         this.panelCaption1.Size = new System.Drawing.Size(730, 26);
         ...
         this.Name = "MAN009LView";
         this.Size = new System.Drawing.Size(730, 421);
        ...
        private Controls.Entidad EntidadAyuda;
        private System.Windows.Forms.Label lblEntidadM;
        private Infrastructure.WinForms.Controls.TextBoxAyuda TxtRazonSocialAyudaEntidad;
        ...
        private System.Windows.Forms.TextBox txtENTC_RazonSoc;
