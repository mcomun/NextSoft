   ...
   public partial class CAJ012IngresoLibrePresenter
   {
      ...
      public Boolean DesvincularAsiento(CtaCte.TipoDesvinculacion x_opcion)
      {
         try
         {
            ...
            {
               Delfin.Comercial.Procesos.Finanzas.CAJ012IngresoLibreDView DView = new Procesos.Finanzas.CAJ012IngresoLibreDView(x_asiento);
      ...
      public Boolean EnviarADiario()
      {
         try
         {
            ...
            Delfin.Comercial.Procesos.Finanzas.CAJ012IngresoLibre.CAJ012IngresoLibreAView AView = new Procesos.Finanzas.CAJ012IngresoLibre.CAJ012IngresoLibreAView();
