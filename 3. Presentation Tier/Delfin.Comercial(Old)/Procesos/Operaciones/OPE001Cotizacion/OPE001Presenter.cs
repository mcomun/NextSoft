...
using Delfin.Comercial.Reportes;
      ...
      public void ImprimirAnexo(Anexos ItemAnexo)
      {
         try
         {
            ...
            if (dtAnexo != null)
            {
               ...
               {
                  //_path = "Delfin.Comercial.Reportes.OPE001Anexos.rptAnexo1.rdlc";
               ...
               {
                  //_path = "Delfin.Comercial.Reportes.OPE001Anexos.rptAnexo2.rdlc";
      ...
      public void ImprimirMatrizDraft()
      {
         try
         {
            ...
            if (dsMatriz != null)
            {
               ...
               //String _path = "Delfin.Comercial.Reportes.OPE001MatrizDraft.rptMatrizDraft.rdlc";
      ...
      public void ImprimirEtiquetas()
      {
         try
         {
            ...
            if (dtEtiqueta != null && dtEtiqueta.Rows.Count > 0)
            {
               ...
               //String _path = "Delfin.Comercial.Reportes.OPE001Etiqueta.rtpEtiqueta.rdlc";
