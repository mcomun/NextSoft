...
Public Class LogisticOperationRegisterBAKForm
    ...
    Private Sub LogisticOperationRegisterForm_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        If Transaction = 0 Then 'New Item
            NewItem()
        ElseIf Transaction = 1 Then 'Edit Item
            SetItem()
        End If
    ...
    Private Sub SetItem()
        ...
        If dsOperationRelated.Tables(5).Rows.Count > 0 Then
            gcService.DataSource = dsOperationRelated.Tables(5)
