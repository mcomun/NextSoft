      ...
      try
      {
        ...
        if (Row == 1)
        {
          foreach (string record in records)
          {
            ...
            table1.Cell(Row, Column)[][] = record;
            // ISSUE: reference to a compiler-generated method
            table1.Cell(Row, Column)[].Font.Bold = 1;
            ++Column;
          }
          // ISSUE: variable of a compiler-generated type
          Rows rows1 = table1.Rows;
        ...
        else if (!ultimo)
        {
          foreach (string record in records)
          {
            ...
            table1.Cell(Row, Column)[][] = record;
            // ISSUE: reference to a compiler-generated method
            table1.Cell(Row, Column)[].Font.Bold = 0;
            ++Column;
          }
          // ISSUE: variable of a compiler-generated type
          Rows rows1 = table1.Rows;
        ...
        else
        {
          foreach (string record in records)
          {
            ...
            table1.Cell(Row, Column)[].Font.Bold = 1;
            // ISSUE: reference to a compiler-generated method
            table1.Cell(Row, Column)[].Borders[WdBorderType.wdBorderTop].LineStyle = WdLineStyle.wdLineStyleSingle;
            ++Column;
          }
        }
      }
