...
// Type: Delfin.Controls.EmailFiles
...
namespace Delfin.Controls
{
  public class EmailFiles
  {
        ...
        foreach (DataRow row in (InternalDataCollectionBase) DtAvisos.Rows)
        {
          ...
          if (Convert.ToString(row["CONS_CodRGM"]) == "002")
          {
            switch (Convert.ToString(row["CONS_CodVia"]))
            {
              case "002":
                x_xd.FindAndReplace((object) "<_lugar_fecha>", (object) ("San Isidro, " + today.ToString("D")));
                x_xd.FindAndReplace((object) "<_nro_ove>", (object) Convert.ToString(row[nameof (CCOT_NumDoc)]));
                x_xd.FindAndReplace((object) "<_nombre_cliente>", (object) Convert.ToString(row["ENTC_NomCliente"]));
    ...
    {
      this.ContainerService = UnityContainerSingleton.get_Instance();
      ...
      dataAccessFilterSql1.set_FilterValue((object) NVIA_Codigo);
      ...
      dataAccessFilterSql3.set_FilterName("@pintCCOT_Numero");
      dataAccessFilterSql3.set_FilterValue((object) CCOT_Numero);
      ...
      dataAccessFilterSql5.set_FilterName("@pvchCNTR_Numero");
      dataAccessFilterSql5.set_FilterValue((object) CNTR_Numero);
    ...
    private DataTable Relacionados(int? ENTC_CodPadre, string CONS_TabRGM, string CONS_CodRGM, string RELA_Tipo)
    {
      try
      {
        ...
        ObservableCollection<DataAccessFilterSQL> observableCollection2 = observableCollection1;
        DataAccessFilterSQL dataAccessFilterSql1 = new DataAccessFilterSQL();
        dataAccessFilterSql1.set_FilterName("@pintENTC_CodPadre");
        dataAccessFilterSql1.set_FilterValue((object) ENTC_CodPadre);
        dataAccessFilterSql1.set_FilterType((DataAccessFilterTypes) 3);
        dataAccessFilterSql1.set_FilterSize(4);
        DataAccessFilterSQL dataAccessFilterSql2 = dataAccessFilterSql1;
        observableCollection2.Add(dataAccessFilterSql2);
        ObservableCollection<DataAccessFilterSQL> observableCollection3 = observableCollection1;
        DataAccessFilterSQL dataAccessFilterSql3 = new DataAccessFilterSQL();
        dataAccessFilterSql3.set_FilterName("@pchrCONS_TabRGM");
        dataAccessFilterSql3.set_FilterValue((object) CONS_TabRGM);
        dataAccessFilterSql3.set_FilterType((DataAccessFilterTypes) 1);
        dataAccessFilterSql3.set_FilterSize(3);
        DataAccessFilterSQL dataAccessFilterSql4 = dataAccessFilterSql3;
        observableCollection3.Add(dataAccessFilterSql4);
        ObservableCollection<DataAccessFilterSQL> observableCollection4 = observableCollection1;
        DataAccessFilterSQL dataAccessFilterSql5 = new DataAccessFilterSQL();
        dataAccessFilterSql5.set_FilterName("@pchrCONS_CodRGM");
        dataAccessFilterSql5.set_FilterValue((object) CONS_CodRGM);
        dataAccessFilterSql5.set_FilterType((DataAccessFilterTypes) 1);
        dataAccessFilterSql5.set_FilterSize(3);
        DataAccessFilterSQL dataAccessFilterSql6 = dataAccessFilterSql5;
        observableCollection4.Add(dataAccessFilterSql6);
        ...
        dataAccessFilterSql7.set_FilterName("@pchrRELA_Tipos");
        dataAccessFilterSql7.set_FilterValue((object) RELA_Tipo);
        dataAccessFilterSql7.set_FilterType((DataAccessFilterTypes) 1);
        dataAccessFilterSql7.set_FilterSize(3);
    ...
    private DataTable PorPagar(short? EMPR_Codigo, int? CCOT_Numero)
    {
      try
      {
        ...
        dataAccessFilterSql1.set_FilterValue((object) EMPR_Codigo);
